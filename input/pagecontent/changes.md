...
39. **Submitted**: CDex Patient Demographics Profile ([FHIR-38252](https://jira.hl7.org/browse/FHIR-38252)) See Changes [Here](#)
40. **Submitted**: Incorrect operation name ([FHIR-38253](https://jira.hl7.org/browse/FHIR-38253)) See Changes [Here](#)
41. **Submitted**: Duplicate text ([FHIR-38254](https://jira.hl7.org/browse/FHIR-38254)) See Changes [Here](#)
42. **Submitted**: small typo ([FHIR-38255](https://jira.hl7.org/browse/FHIR-38255)) See Changes [Here](#)
43. **Submitted**: cdex-temp code system must not be used in implemented systems ([FHIR-38259](https://jira.hl7.org/browse/FHIR-38259)) See Changes [Here](#)
44. **Applied**: Clarify use of data tagging ([FHIR-38286](https://jira.hl7.org/browse/FHIR-38286)) See Changes [Here](security.html#sensitive-and-confidential-data)
45. **Partially Applied**: Updated X12 element mappings and X12 required citations ([FHIR-38287](https://jira.hl7.org/browse/FHIR-38287)) See Changes [Here](requesting-attachments-code.html#data-elements-for-requesting-attachments) and Changes [Here](sending-attachments.html#data-elements-for-sending-attachments)
46. **Triaged**: FHIR ID Support and Usage ([FHIR-38318](https://jira.hl7.org/browse/FHIR-38318)) See Changes [Here](#)
47. **Waiting for Input**: Liability and Privacy Concerns with Digital Signature ([FHIR-38320](https://jira.hl7.org/browse/FHIR-38320)) See Changes [Here](#)
48. **Submitted**: Clarification regarding reassociation being out of scope ([FHIR-38322](https://jira.hl7.org/browse/FHIR-38322)) See Changes [Here](#)
49. **Triaged**: Task Reason Code ([FHIR-38325](https://jira.hl7.org/browse/FHIR-38325)) See Changes [Here](#)
50. **Applied**: Clarify X12 Compatibility ([FHIR-38326](https://jira.hl7.org/browse/FHIR-38326)) See Changes [Here](sending-attachments.html#sending-attachments)
51. **Triaged**: Adding Qualifier to Signed Document Bundle ([FHIR-38327](https://jira.hl7.org/browse/FHIR-38327)) See Changes [Here](#)
52. **Submitted**: Remove words ""transaction layer"" for conciseness ([FHIR-38328](https://jira.hl7.org/browse/FHIR-38328)) See Changes [Here](#)
53. **Submitted**: Word change ""analogs"" to ""fields"" ([FHIR-38330](https://jira.hl7.org/browse/FHIR-38330)) See Changes [Here](#)
54. **Submitted**: Confirm parameter naming style ([FHIR-38366](https://jira.hl7.org/browse/FHIR-38366)) See Changes [Here](#)
55. **Submitted**: Improve rendered document rendering ([FHIR-38367](https://jira.hl7.org/browse/FHIR-38367)) See Changes [Here](#)
56. **Submitted**: *Signed* should be in italics ([FHIR-38368](https://jira.hl7.org/browse/FHIR-38368)) See Changes [Here](#)
57. **Triaged**: stronger language needed  ([FHIR-38576](https://jira.hl7.org/browse/FHIR-38576)) See Changes [Here](#)
58. **Triaged**: revise section 'what Do Payers Do with Clinical Information?' ([FHIR-38578](https://jira.hl7.org/browse/FHIR-38578)) See Changes [Here](#)
59. **Triaged**: add supplemental guide to example scenarios  ([FHIR-38580](https://jira.hl7.org/browse/FHIR-38580)) See Changes [Here](#)
60. **Triaged**: CDex use case examples  ([FHIR-38585](https://jira.hl7.org/browse/FHIR-38585)) See Changes [Here](#)
61. **Submitted**: question related to authoring/sign off ([FHIR-38588](https://jira.hl7.org/browse/FHIR-38588)) See Changes [Here](#)
62. **Submitted**: Concerned about the need for human intervention if the patient matching tech isn't built out ([FHIR-38592](https://jira.hl7.org/browse/FHIR-38592)) See Changes [Here](#)
63. **Triaged**: add limited payer access for the preconditions and assumptions  ([FHIR-38595](https://jira.hl7.org/browse/FHIR-38595)) See Changes [Here](#)
64. **Triaged**: does Da Vinci plan to standardize a way to communicate failed signatures?  ([FHIR-38596](https://jira.hl7.org/browse/FHIR-38596)) See Changes [Here](#)
65. **Triaged**: statement on purpose of use should be stronger  ([FHIR-38598](https://jira.hl7.org/browse/FHIR-38598)) See Changes [Here](#)
66. **Triaged**: change SHOULD to SHALL ([FHIR-38599](https://jira.hl7.org/browse/FHIR-38599)) See Changes [Here](#)
67. **Triaged**: term used  ([FHIR-38600](https://jira.hl7.org/browse/FHIR-38600)) See Changes [Here](#)
68. **Triaged**: Would there be a claim associated with a HEDIS lab value request for quality reporting? ([FHIR-38601](https://jira.hl7.org/browse/FHIR-38601)) See Changes [Here](#)
69. **Triaged**: Polling frequency ([FHIR-38602](https://jira.hl7.org/browse/FHIR-38602)) See Changes [Here](#)
70. **Applied**: Remove inaccurate staement about trading partner agreements ([FHIR-38603](https://jira.hl7.org/browse/FHIR-38603)) See Changes [Here](solicited-unsolicited-attachments.html#unsolicited-attachments)
71. **Submitted**: used word provider when you meant payer  ([FHIR-38604](https://jira.hl7.org/browse/FHIR-38604)) See Changes [Here](#)
72. **Triaged**: scope  ([FHIR-38605](https://jira.hl7.org/browse/FHIR-38605)) See Changes [Here](#)
73. **Triaged**: Need a new example for Signed FHIR Resource Attachments ([FHIR-38609](https://jira.hl7.org/browse/FHIR-38609)) See Changes [Here](#)
74. **Triaged**: remove reference to HIPAA attachments rule  ([FHIR-38612](https://jira.hl7.org/browse/FHIR-38612)) See Changes [Here](#)
75. **Waiting for Input**: change SHOULD to SHALL ([FHIR-38613](https://jira.hl7.org/browse/FHIR-38613)) See Changes [Here](#)
76. **Applied**: Change $submit-attachment's Attachment input parameter to min=1. ([FHIR-38632](https://jira.hl7.org/browse/FHIR-38632)) See Changes [Here](OperationDefinition-submit-attachment.html)
77. **Applied**: Change Tracking-id.system to Must Support; and $submit-attachment TrackingId to type Identifier. ([FHIR-39337](https://jira.hl7.org/browse/FHIR-39337)) See Changes [Here](OperationDefinition-submit-attachment.html) and [Here](StructureDefinition-cdex-task-attachment-request.html)
78. **Applied**: Update NPI codesystem  ([FHIR-39626](https://jira.hl7.org/browse/FHIR-39626)) See Changes [Here](ValueSet-cdex-identifier-types.html)
