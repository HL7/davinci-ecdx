...
1. **Submitted:** Attachments Section Unsolicited Work Flow ([FHIR-36733](https://jira.hl7.org/browse/FHIR-36733)) See Changes [Here](#.html)
1. **Submitted:** Submit attachment operation sentence modification ([FHIR-36735](https://jira.hl7.org/browse/FHIR-36735)) See Changes [Here](#.html)
1. **Submitted:** Fix Typo  sef-signed ([FHIR-36736](https://jira.hl7.org/browse/FHIR-36736)) See Changes [Here](#.html)
1. **Submitted:** Explicitly call out that HRex and FHIR define the content that is exchanged, while CDex defines additional conditions for how it is exchanged ([FHIR-36741](https://jira.hl7.org/browse/FHIR-36741)) See Changes [Here](#.html)
1. **Submitted:** SubmitAttachment AttachTo text correction ([FHIR-36756](https://jira.hl7.org/browse/FHIR-36756)) See Changes [Here](#.html)
1. **Submitted:** Unclear why certain inputs are required ([FHIR-36757](https://jira.hl7.org/browse/FHIR-36757)) See Changes [Here](#.html)
1. **Submitted:** Clarify that signature.who should reference an Organization resource or Practitioner resource ([FHIR-36846](https://jira.hl7.org/browse/FHIR-36846)) See Changes [Here](#.html)
1. **Submitted:** sentence fragments ([FHIR-36848](https://jira.hl7.org/browse/FHIR-36848)) See Changes [Here](#.html)
...
1. **Submitted:** Capitalization consistency ([FHIR-36896](https://jira.hl7.org/browse/FHIR-36896)) See Changes [Here](#.html)
1. **Submitted:** Operation link consistency ([FHIR-36897](https://jira.hl7.org/browse/FHIR-36897)) See Changes [Here](#.html)
1. **Submitted:** Incorrect request URL in examples ([FHIR-36898](https://jira.hl7.org/browse/FHIR-36898)) See Changes [Here](#.html)
1. **Submitted:** Small edits to the Signature page ([FHIR-36905](https://jira.hl7.org/browse/FHIR-36905)) See Changes [Here](#.html)
1. **Submitted:** Small edits to SubmitAttachment operation page ([FHIR-36906](https://jira.hl7.org/browse/FHIR-36906)) See Changes [Here](#.html)
1. **Submitted:** Incomplete Narrative Content rendering of Submit Attachment Parameters Resource example ([FHIR-36907](https://jira.hl7.org/browse/FHIR-36907)) See Changes [Here](#.html)
1. **Submitted:** Missing examples  ([FHIR-37245](https://jira.hl7.org/browse/FHIR-37245)) See Changes [Here](#.html)
1. **Submitted:** We appreciate the robust P&S section ([FHIR-37247](https://jira.hl7.org/browse/FHIR-37247)) See Changes [Here](#.html)
1. **Submitted:** please rewrite  ([FHIR-37252](https://jira.hl7.org/browse/FHIR-37252)) See Changes [Here](#.html)
1. **Triaged:** Clarify support (or not) for XML with signatures ([FHIR-37264](https://jira.hl7.org/browse/FHIR-37264)) See Changes [Here](#.html)
1. **Submitted:** Add clarification on how to handle reads when signatures are needed ([FHIR-37265](https://jira.hl7.org/browse/FHIR-37265)) See Changes [Here](#.html)
1. **Triaged:** In diagram, show 200 ok w/ OperationOutcome ([FHIR-37271](https://jira.hl7.org/browse/FHIR-37271)) See Changes [Here](#.html)
1. **Triaged:** Submission process needs to identify what payer we're sending to ([FHIR-37331](https://jira.hl7.org/browse/FHIR-37331)) See Changes [Here](#.html)
1. **Triaged:** Need clarification on whether claims attachment submitter is same as claim submitter ([FHIR-37332](https://jira.hl7.org/browse/FHIR-37332)) See Changes [Here](#.html)
