...
61. ****Resolved-Change Required****: Create failed signature example transaction ([FHIR-38596](https://jira.hl7.org/browse/FHIR-38596)) See Changes [Here](#)
62. **Applied**: Clarify benefits of POU element ([FHIR-38598](https://jira.hl7.org/browse/FHIR-38598)) See Changes [Here](#)
...
64. **Triaged**: term used  ([FHIR-38600](https://jira.hl7.org/browse/FHIR-38600)) See Changes [Here](#)
65. **Triaged**: Would there be a claim associated with a HEDIS lab value request for quality reporting? ([FHIR-38601](https://jira.hl7.org/browse/FHIR-38601)) See Changes [Here](#)
