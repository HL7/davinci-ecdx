...
40. **Resolved-Change Required**: cdex-temp code system must not be used in implemented systems ([FHIR-38259](https://jira.hl7.org/browse/FHIR-38259)) See Changes [Here](#)
...
43. **Applied**: FHIR ID Support and Usage ([FHIR-38318](https://jira.hl7.org/browse/FHIR-38318)) See Changes [Here](direct-query.html#discovery-of-patient-fhir-ids)
...
48. **Applied**: Correct rendering of CCDA ([FHIR-38367](https://jira.hl7.org/browse/FHIR-38367)) See Changes [Here](task-based-approach.html#surgical-notes-as-ccda)
...
54. **Applied**: Create failed signature example transaction ([FHIR-38596](https://jira.hl7.org/browse/FHIR-38596)) See Changes [Here](file:///Users/ehaas/Documents/FHIR/davinci-ecdx/output/sending-attachments.html#signatures)
