...
42. **Resolved-Change Required**: cdex-temp code system must not be used in implemented systems ([FHIR-38259](https://jira.hl7.org/browse/FHIR-38259)) See Changes [Here](#)
...
71. **Resolved-Change Required**: Clarify association comment and assign FMM levels to guide  ([FHIR-38605](https://jira.hl7.org/browse/FHIR-38605)) See Changes [Here](background.html#steps-2)
