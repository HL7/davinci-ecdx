...
29. **Applied:** Typo correction ([FHIR-37229](https://jira.hl7.org/browse/FHIR-37229)) See Changes [Here](#.html)
30. **Triaged:** Describe reasoning for choosing Bundle.signature in attachment signatures or signatures page ([FHIR-37230](https://jira.hl7.org/browse/FHIR-37230)) See Changes [Here](#.html)
31. **Submitted:** Same comment as above ([FHIR-37231](https://jira.hl7.org/browse/FHIR-37231)) See Changes [Here](#.html)
32. **Applied:** minor text edits ([FHIR-37233](https://jira.hl7.org/browse/FHIR-37233)) See Changes [Here](#.html)
33. **Applied:** Clarify Figure 7 step 4 text to match the description ([FHIR-37234](https://jira.hl7.org/browse/FHIR-37234)) See Changes [Here](#.html)
34. **Applied:** operation name used in examples  ([FHIR-37235](https://jira.hl7.org/browse/FHIR-37235)) See Changes [Here](#.html)
35. **Pre-Applied:** Rewrite introduction to Signature ([FHIR-37243](https://jira.hl7.org/browse/FHIR-37243)) See Changes [Here](signatures.html)
