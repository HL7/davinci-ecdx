...
1. **[Attachments]** Based on pre-defined payor rules or business needs the EHR sends claims or prior authorization data directly to Payer using a "push" based operation.
