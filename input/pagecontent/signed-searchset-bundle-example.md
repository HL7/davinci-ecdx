...
1. Update the Jupyter file at https://github.com/HL7/davinci-ecdx/blob/master/CDEX-Signatures/Digsig_Searchset_Bundle_Example.ipynb
2. Create Markdown version of file using command line instruction:
 `jupyter nbconvert --to markdown ~/Digsig_Searchset_Bundle_Example.ipynb` 
 Note need to use a compatible python environment to run this 
3. Copy/paste the markdown file ~/Digsig_Searchset_Bundle_Example.md to ~/input/pagecontent/signed-searchset-bundle-example.md
